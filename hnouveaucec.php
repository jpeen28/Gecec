...
if(isset($_GET['search'])){
    ...
    $sql = $bdd->query('select * from nouveaucec where nom like"%'.$recherche.'%" or prenom like"%'.$recherche.'%" or username like "%'.$recherche.'%"');
}
?>
        ...
        <div class="container hcollecte">
            <div class="card mt-5 tab" id="print" >
                <div class="card-header print">
                    <h2 class="new-user-title">Historiques de Nouveau Centre d'Etat Civil</h2>
                    <div>
                                ...
                                while($user = $sql->fetch()){
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $user['localite'];?></td>
                                            <td><?= $user['nomcec'];?></td>
                                            <td><?= $user['naturecec'];?></td>
                                            <td>
                                                <a href="modifiercec.php?id=<?= $user['id'] ?>" ><img title="modifier" src="./img/pen.png" style="width:20px"></a>
