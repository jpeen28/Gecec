...
$id = $_GET['id'];
$stmt = $pdo->prepare("SELECT * FROM statistique where Id=id");
$stmt->execute([':id' => $id ]);
                    ...
                    <div id="form-total">
                        ...
                        <section>
                            <div class="inner">
                                ...
                                <div id="Nature">
                                    ...
                                    <div>
                                    <input type="text" value="<?= $collecte->code?>" placeholder="Code du Centre d'etat Civil" id="code_cec"class="Nature-Name" disabled>
                                    </div>
                                </div>
                                <div class="form-row">
                        ...
                        <section>
                            <div class="inner">
                                ...
                                <div class="form-row">
                                    <div class="form-holder">
                                        <label class="form-row-inner">
											<input type="text"  value="<?= $collecte->nbrregnais;?>" name="regnaissance" id="regnaissance" onchange="getTotal()" class="form-control" required>
                                    ...
                                    <div class="form-holder">
                                        <label class="form-row-inner">
											<input type="text"value="<?= $collecte->nbrregmar;?>" name="regmariage" id="regmariage" onchange="getTotal()" class="form-control" required>
                                ...
                                <div class="form-row">
                                    <div class="form-holder">
                                        <label class="form-row-inner">
											<input type="text" value="<?= $collecte->nbrregdec;?>" name="regdeces" id="regdeces" onchange="getTotal()" class="form-control" required>
                                ...
                                <div class="form-row">
                                    <div class="form-holder">
                                        <label class="form-row-inner">
											<input type="text" value="<?= $collecte->nbrregpara;?>" name="regparaphe" class="form-control" required>
                                    ...
                                    <div class="form-holder">
                                        <label class="form-row-inner">
											<input type="text" value="<?= $collecte->nbrregclot;?>" name="regcloture"  class="form-control" required>
                        ...
                        <section>
                            <div class="inner">
                                ...
                                <div class="form-row">
                                    <div class="form-holder">
                                        <label class="form-row-inner">
											<input type="text" value="<?= $collecte->nbractnai;?>" class="form-control" id="first-name-1" name="naissance" required>
                                    ...
                                    <div class="form-holder">
                                        <label class="form-row-inner">
											<input type="text" value="<?= $collecte->nbractmar;?>" class="form-control" id="last-name-1" name="mariage" required>
                                ...
                                <div class="form-row">
                                    <div class="form-holder">
                                        <label class="form-row-inner">
											<input type="text" value="<?= $collecte->nbractdec;?>" class="form-control" id="first-name-1" name="deces" required>
                        ...
                        <section>
                            <div class="inner">
                                ...
                                <div class="form-holder form-holder-2">
                                    <select name="etat">
										<option value="<?= $collecte->fonctionnel;?>" disabled selected><?= print_r($collecte->fonctionnel) ;?></option>
                                    ...
                                    <div class="form-holder form-holder-2">
                                        <label class="form-row-inner">
											<input type="text" value="<?= $collecte->commentaire;?>" name="observation" id="balance" class="form-control" required>
